...
advance!(rep::AbstractInterfaceRep, v_nodes, t, dt) =
    throw(MethodError(advance!, (rep, v_nodes, t, dt)))
predict_phi(rep::AbstractInterfaceRep, v_prev_nodes, t, dt) =
    throw(MethodError(predict_phi, (rep, v_prev_nodes, t, dt)))
